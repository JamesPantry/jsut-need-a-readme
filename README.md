...
Ensures separation of roles and prevents unauthorised access.
...
Accessible at:
http://<VM_IP>/student/ with text/plain MIME type.
...
Static site for VM IP and
stu-664398-vm1.net.dcs.hull.ac.uk

Docker application served via
docker.stu-664398-vm1.net.dcs.hull.ac.uk
and proxied to http://172.20.0.10:3000.
...
Keep /srv/www owned by root to prevent unauthorised modifications.
